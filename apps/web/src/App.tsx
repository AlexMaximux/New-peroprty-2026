  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 h-64 w-96 rounded-full bg-emerald-500/5 blur-[100px]" />
        ...
        <div className="page-container relative z-10 flex min-h-[70vh] flex-col items-center justify-center text-center">
          ...
          <div className="mt-10 flex gap-4">
            ...
            <a href="/login" className="btn-secondary text-base !px-8 !py-3">
              Sign In
            </a>
          </div>
        </div>
